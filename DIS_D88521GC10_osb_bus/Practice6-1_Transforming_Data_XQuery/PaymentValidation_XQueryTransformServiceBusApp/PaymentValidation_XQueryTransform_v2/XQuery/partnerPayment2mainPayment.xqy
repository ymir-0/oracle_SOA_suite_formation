...
declare function local:transPaymentStatus($partnerPayment as element() (:: element(*, ns1:PaymentType) ::)) as element() (:: element(*, ns2:PaymentType) ::) {
    <ns2:PaymentType>
...
local:transPaymentStatus($partnerPayment)
